export const ANNOUNCEMENTS = [
  {
    date: '2026-06-30',
    message:
      '新增 API 狀態頁：首頁可進入，後端每 15 分鐘自動檢測各鏡像源的詳情、目錄、章節與評論端點，並以表格顯示整體與各項健康狀態。頂部導覽列「API 服務」選單中，各鏡像源旁會顯示狀態標籤，選單底部亦可快速前往狀態頁；閱讀時可隨時切換鏡像源。狀態頁支援手動重新整理，取得最新檢測結果。',
  },
  {
    date: '2026-06-27',
    urgent: true,
    message:
      '近期發現部分使用者以極高頻率惡意濫用 API，嚴重影響其他讀者的正常閱讀體驗。本站僅供個人閱讀使用，不支援大規模爬蟲、批量抓取或自動化工具。請尊重其他使用者，勿以高頻請求佔用共用資源、破壞他人閱讀體驗。我們已封禁部分違規使用者，並將持續對濫用行為採取封禁措施，敬請配合。',
  },
  {
    date: '2026-06-27',
    message: '書架列表視圖恢復每本書籍右上角的快捷按鈕（加入收藏夾、刷新、刪除／移除），進入管理模式時會自動隱藏，改由底部工具列批次操作。格狀視圖維持簡潔封面展示，不顯示單書按鈕。目錄章節管理模式預設開啟，下載、刷新與刪除章節的按鈕會直接顯示；偏好會記住，重新整理或切換書籍後仍生效，不需要時可點擊「管理章節」關閉。',
  },
  {
    date: '2026-06-22',
    message: 'API 服務現已恢復可用。',
  },
  {
    date: '2026-06-20',
